...
class User(models.Model):
    ...
    uname = models.CharField(max_length=255, blank=True, null=True)
    follow_count = models.BigIntegerField(blank=True, null=True)
    followers_count = models.BigIntegerField(blank=True, null=True)
    statuses_count = models.BigIntegerField(blank=True, null=True)
    verified = models.BigIntegerField(blank=True, null=True)
    fans_list_id = models.BigIntegerField(blank=True, null=True)
    more_list_id = models.BigIntegerField(blank=True, null=True)
    activefans_count = models.BigIntegerField(db_column='activeFans_count', blank=True, null=True)  # Field name made lowercase.
    verifiedfans_count = models.BigIntegerField(db_column='verifiedFans_count', blank=True, null=True)  # Field name made lowercase.
    original_count = models.BigIntegerField()
