...
def get_area_hot_word(request):#获取热门词云
    ...
    if request.method == 'POST':
        if Area_name:
            ...
            hot_word_dic = {'远程教育':0.25,'双减':0.3,'K12':0.2,'高考':0.3,'中考':0.2,'课外辅导':0.3,'研学':0.2}#tfidf.tfidf_cal(articles)
...
def get_area_source_influence(request):#获取媒体影响力
    ...
    if request.method == 'POST':
        if Area_name:
            ...
            influence_dic = {'code': 0, 'date':[{'name':'微博', 'value':wb}, {'name':'网易','value': wy}, {'name':'人民网','value':rm}]}
